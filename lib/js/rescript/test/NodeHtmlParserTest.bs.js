...
Mocha$RescriptMocha.describe("test HtmlElement")(undefined, undefined, undefined, (function (param) {
        Mocha$RescriptMocha.describe("test removeWhitespaceMut")(undefined, undefined, undefined, (function (param) {
                Mocha$RescriptMocha.it("test 1")(undefined, undefined, undefined, (function (param) {
                        ...
                        var result = NodeHtmlParser.HtmlElement.toString(NodeHtmlParser.HtmlElement.removeWhitespaceMut(given));
        ...
        Mocha$RescriptMocha.describe("test insertAdjacentHtmlMut")(undefined, undefined, undefined, (function (param) {
                Mocha$RescriptMocha.it("test 1")(undefined, undefined, undefined, (function (param) {
                        ...
                        var result = NodeHtmlParser.HtmlElement.toString(Belt_Result.getExn(NodeHtmlParser.HtmlElement.insertAdjacentHtmlMut(given, "afterbegin", "<b>sadas</b>")));
        ...
        Mocha$RescriptMocha.describe("test setAttributesMut")(undefined, undefined, undefined, (function (param) {
                Mocha$RescriptMocha.it("test 1")(undefined, undefined, undefined, (function (param) {
                        var given = NodeHtmlParser.parse(" <div> <div>  8hsad</div><div>mda0s</div> </div>");
                        var result = NodeHtmlParser.HtmlElement.toString(NodeHtmlParser.HtmlElement.setAttributesMut(Belt_Option.getExn(Belt_Result.getExn(NodeHtmlParser.HtmlElement.querySelector(given, "div"))), [
                                  [
                                    "a1",
                                    "v1"
                                  ],
        ...
        Mocha$RescriptMocha.describe("test replaceWithMut")(undefined, undefined, undefined, (function (param) {
                Mocha$RescriptMocha.it("test 1")(undefined, undefined, undefined, (function (param) {
                        ...
                        NodeHtmlParser.HtmlElement.replaceWithMut(Belt_Option.getExn(Belt_Result.getExn(NodeHtmlParser.HtmlElement.querySelector(given, "#idEl"))), "<a>Hello</a>");
                        var result = NodeHtmlParser.HtmlElement.toString(given);
        ...
        Mocha$RescriptMocha.describe("test removeMut")(undefined, undefined, undefined, (function (param) {
                Mocha$RescriptMocha.it("test 1")(undefined, undefined, undefined, (function (param) {
                        var given = NodeHtmlParser.parse(" <div> <div id=\"idEl\">  8hsad</div><div>mda0s</div> </div>");
                        NodeHtmlParser.HtmlElement.removeMut(Belt_Option.getExn(Belt_Result.getExn(NodeHtmlParser.HtmlElement.querySelector(given, "#idEl"))));
                        var result = NodeHtmlParser.HtmlElement.toString(given);
